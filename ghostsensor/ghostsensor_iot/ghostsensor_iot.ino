...
void setup() {
  ...
  ledCmd(0x81);              // Display on, no blink
   ...
   ddbClient.setAWSSecretKey("U6WbRbjUvNLd0D+8CcoKLic49p3C9aZ6vv4qTVvL");
   ddbClient.setAWSKeyID("AKIAIUTNWN7TMM2T2QMA");
...
void loop() {
  ...
  if(light>0){
    ...
    deviceValue.setS(String(timeValue));
    ...
    MinimalKeyValuePair < MinimalString, AttributeValue
            > att1( "date", deviceValue );
    MinimalKeyValuePair < MinimalString, AttributeValue
            > att2( "motion", String(light) );
